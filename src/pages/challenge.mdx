...
description: Challenges for Explorer Course
hide_table_of_contents: true
---
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=8300990&assignment_repo_type=AssignmentRepo)

# 🧪 Explorer Challenge  🧪

<p style={{color: "#32ce66", fontSize: "25px", textAlign: "center"}}> 👋🏼 ¡Bienvenido  al Explorer Challenge! 👋🏼 </p>

<p style={{color: "#00a7d3", fontSize: "20px", textAlign: "center"}}> ⚠️  ¡Antes de empezar tu reto lee detenidamente la siguiente información! ⚠️ </p>
...
<p style={{color:"#00a7d3", fontSize: "20px", textAlign:"center"}}> ⚠️  ¡Debes investigar por tu cuenta, recuerda que Google es tu mejor aliado! ⚠️ </p>

### Pasos para resolver el Explorer Challenge:

#### 1. Acceder al explorer challenge desde la plataforma de <a href="https://academy.agileinnova.org" target="_blank">Agile Innova Academy</a>
