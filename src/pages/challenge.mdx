...
#### 1. Acceder al explorer challenge desde la plataforma de <a href="https://academy.campusvirtual.com.co" target="_blank">Campus Virtual Academy</a>
...
- Una vez finalizado, verifica:

:round_pushpin: Que veas los cambios reflejados en tu repositorio `explorer-challenge-[TU_CUENTA_DE_GITHUB]` ingresando a la organización de [Campus Virtual Academy](https://github.com/Agile-Innova-Academy) en **GitHub**
