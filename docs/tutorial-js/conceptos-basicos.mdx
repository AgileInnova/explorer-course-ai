...
import "../../src/components/BtnHomeworks/styles.css";
  ...
  <div className="card-demo cardDemo">
    <div className="card" style={{ backgroundColor: "#242526" }}>
      ...
      <div className="card__body">
        <a href="https://github.com/Agile-Innova-Academy/explorer-course/blob/main/2.%20Javascript/01-Conceptos-Basicos/Ejercicios-para-Practicar.md" target="_blank">
          <button
        ...
        <a href="https://github.com/Agile-Innova-Academy/explorer-course/blob/main/2.%20Javascript/01-Conceptos-Basicos/Tarea-01/README.md" target="_blank">
          <button
            className="button button--primary button--block"
            style={{ marginBottom: "10px" }}
          >
        ...
        <a href="https://github.com/Agile-Innova-Academy/explorer-course/tree/main/2.%20Javascript/01-Conceptos-Basicos/Tarea-02" target="_blank">
          <button
            className="button button--primary button--block"
            style={{ marginBottom: "10px" }}
          >
        ...
        <a href="https://github.com/Agile-Innova-Academy/explorer-course/tree/main/2.%20Javascript/01-Conceptos-Basicos/Tarea-03" target="_blank">
          <button
            className="button button--primary button--block"
            style={{ marginBottom: "10px" }}
          >
...
<iframe
  width="80%"
  height="315"
  src="https://www.youtube.com/embed/_QyiYXgpkHg"
...
**_Las características de los algoritmos_**
...
```javascript
let usuario = { nombre: "Pepito", apellido: "Perez" };
...
```javascript
<script>
  var nombre = 'Pepito'; console.log('Hola' + nombre + '¿Cómo estás?');
</script>
```
...
**_Diferencia entre let var y const_**

> Tanto las varibales _let_ y _var_ permiten actualizar el valor de una variable mientras que _const_ no lo permite, esta variable es estatica. Las variables definias con _let_ están disponibles dentro de todo el bloque de la función donde fueron declaradas. Y las variables definidas con _var_ están disponibles dentro del bloque de código actual, o sea, el area entre { y }.
